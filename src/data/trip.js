...
export const tripMeta = {
  ...
  people: 2,
  welcomeParagraphs: [
    "¡Bienvenidos a la guía y planificación interactiva del <strong>futuro viaje a Japón</strong>! Una expedición completa que recorre el archipiélago nipón de norte a sur a través de <strong>13 etapas memorables</strong>.",
    "Desde los templos milenarios y los rascacielos vanguardistas de Tokio, la majestuosidad sagrada de Nikko y Kamakura, hasta coronar el <strong>Monte Fuji</strong> (3.776 m) al amanecer. Continuando hacia la vibrante Osaka, la memoria histórica de Hiroshima y el torii flotante de la isla sagrada de Miyajima; para después saltar a las aguas turquesa y el cielo estrellado de Okinawa e Iriomote, culminando en la indómita naturaleza y gastronomía de Hokkaido.",
    "La aplicación es <strong>100% offline</strong> y reúne todo lo necesario para preparar el viaje: el <strong>itinerario etapa por etapa</strong>, el <strong>mapa interactivo</strong> con la ruta geográfica, las recomendaciones de vuelos y transportes (Shinkansen, pases regionales y ferris), las bases de alojamiento y las guías gastronómicas y culturales.",
